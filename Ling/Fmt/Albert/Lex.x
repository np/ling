  ...
  b "]" 23
    (b "<" 12
       (b "->" 6
          ...
          (b ":" 9 (b "." 8 (b "-o" 7 N N) N) (b ";" 11 (b ":]" 10 N N) N)))
       (b "@" 18
          (b "=" 15
    ...
    (b "new" 34
       (b "data" 29
          (b "as" 26
             (b "`" 25 (b "^" 24 N N) N) (b "case" 28 (b "assert" 27 N N) N))
          (b "in" 32 (b "fwd" 31 (b "end" 30 N N) N) (b "let" 33 N N)))
       (b "slice" 40
          (b "proc" 37
             (b "of" 36 (b "new/" 35 N N) N) (b "send" 39 (b "recv" 38 N N) N))
