module Ling.Fmt.Benjamin.Skel where
...
transAct x = case x of
  ...
  ParSplit optsplit chandecs -> failure x
...
transASession x = case x of
  AS aterm -> failure x
transOptSplit :: OptSplit -> Result
transOptSplit x = case x of
  SoSplit name -> failure x
  NoSplit name -> failure x
