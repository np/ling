  ...
  b "^" 25
    (b "<" 13
       ...
       (b "@" 19
          ...
          (b "[:" 22
             (b "[" 21 (b "Type" 20 N N) N) (b "]" 24 (b "\\" 23 N N) N))))
    (b "parallel" 38
       (b "fwd" 32
          (b "case" 29
             (b "as" 27 (b "`" 26 N N) (b "assert" 28 N N))
             (b "end" 31 (b "data" 30 N N) N))
          (b "new" 35
             (b "let" 34 (b "in" 33 N N) N) (b "of" 37 (b "new/" 36 N N) N)))
       (b "split" 44
          (b "send" 41
             (b "recv" 40 (b "proc" 39 N N) N)
             (b "slice" 43 (b "sequence" 42 N N) N))
          (b "|" 47
             (b "{" 46 (b "with" 45 N N) N) (b "~" 49 (b "}" 48 N N) N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
