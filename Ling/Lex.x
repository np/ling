...
resWords =
  b "^" 25
    ...
    (b "of" 37
       (b "end" 31
          (b "assert" 28
             (b "as" 27 (b "`" 26 N N) N) (b "data" 30 (b "case" 29 N N) N))
          (b "let" 34
             (b "in" 33 (b "fwd" 32 N N) N) (b "new/" 36 (b "new" 35 N N) N)))
       (b "split" 43
          (b "recv" 40
             (b "proc" 39 (b "parallel" 38 N N) N)
             (b "sequence" 42 (b "send" 41 N N) N))
          (b "|" 46
             (b "{" 45 (b "with" 44 N N) N) (b "~" 48 (b "}" 47 N N) N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
